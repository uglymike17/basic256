...
// 2.2.0.0 = 2020000. Programs gate on it (TestSuite/testsuite.kbs decodes
...
// asking version() on a 2.2 beta build should be told 2.2, so these two
// are bumped by hand when a new patch line opens.
#define VERSIONSIGNATURE  2020000
#define VERSIONPRODUCT 2,2,0,0
